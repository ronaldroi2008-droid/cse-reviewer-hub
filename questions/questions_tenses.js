...
window.VERBAL_QUESTION_BANK["tenses"] = {
  ...
  beginner: [
    ...
    {
      question:
        "What is the tense of this sentence? 'By tomorrow, we will have finished the task.'",
    ...
    // 34
    {
      ...
      choices: ["Present perfect", "Present continuous", "Present perfect continuous", "Simple present"],
      correctIndex: 2,
      explanation:
    ...
    {
      question:
        "What is the tense of this sentence? 'They have been waiting for you since 3 p.m.'",
      choices: [
  ...
  intermediate: [
    ...
    {
      question:
        "Which sentence shows an action that was in progress when another action happened?",
      choices: [
    ...
    {
      question:
        "Which sentence correctly shows future plans using present continuous?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'She ___ her keys again. She is always losing them.'",
    ...
    {
      question:
        "Choose the correct tense: 'They ___ lunch when we arrived, so we joined them.'",
    ...
    {
      question:
        "Choose the correct tense: 'I ___ in Manila for five years before I moved to Cebu.'",
    ...
    {
      question:
        "Which sentence correctly uses a time clause with future meaning?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'He ___ his lunch by the time the meeting started.'",
    ...
    {
      question:
        "Choose the correct tense: 'I ___ to call you all day, but you were busy.'",
    ...
    {
      question:
        "Which sentence correctly uses present perfect to show recent completion?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'She ___ in the bank before she became a teacher.'",
    ...
    {
      question:
        "Choose the correct tense: 'They ___ the documents by the time you arrive.'",
    ...
    {
      question:
        "Which sentence correctly uses past perfect for a cause?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'I ___ here for an hour before anyone helped me.'",
    ...
    {
      question:
        "Choose the correct tense: 'By the time you get home, I ___ dinner.'",
    ...
    {
      question:
        "Which sentence correctly uses a time clause in the past?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'We ___ our guests at 7 p.m. tomorrow.'",
    ...
    {
      question:
        "Which sentence correctly uses present perfect with for?",
      choices: [
  ...
  advanced: [
    // 1
    {
      ...
      choices: ["have finished", "the report", "yesterday", "no error"],
      correctIndex: 0,
      explanation:
    ...
    {
      question:
        "Choose the best correction: 'When I was young, I have gone to that park every day.'",
      choices: [
    ...
    {
      question:
        "Choose the correct verb form: 'By the time you arrived, we ___ our lunch.'",
    ...
    {
      question:
        "Which sentence correctly uses present perfect to link past and present?",
      choices: [
    ...
    {
      question:
        "Which sentence correctly expresses an unreal present condition?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense pattern: 'If they had left earlier, they ___ the bus.'",
    ...
    {
      question:
        "Which sentence correctly uses future perfect continuous?",
      choices: [
    ...
    {
      question:
        "Choose the best correction: 'When I will see him, I will tell him the news.'",
      choices: [
    ...
    {
      question:
        "Which sentence correctly uses reported speech in the past?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'No sooner ___ the words than she regretted them.'",
    ...
    {
      question:
        "Which sentence correctly uses a mixed conditional (past condition, present result)?",
      choices: [
    ...
    {
      question:
        "Choose the best correction: 'He said that he will call me later.'",
      choices: [
    ...
    {
      question:
        "Which sentence correctly uses present perfect for unfinished time?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'By 2019, he ___ in that company for ten years.'",
    ...
    {
      question:
        "Which sentence correctly avoids unnecessary past perfect?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'She ___ never seen snow before that trip.'",
    ...
    {
      question:
        "Which sentence correctly uses future perfect to emphasize completion?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'He ___ for the bus for thirty minutes when it finally arrived.'",
    ...
    {
      question:
        "Which sentence correctly uses a reduced time clause?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'Scarcely ___ arrived when the meeting began.'",
    ...
    {
      question:
        "Which sentence correctly uses present perfect continuous for recent activity?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'She ___ in the library when I saw her yesterday.'",
    ...
    {
      question:
        "Which sentence correctly expresses a future plan decided before speaking?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'He ___ a lot of progress lately.'",
    ...
    {
      question:
        "Which sentence correctly uses past perfect for an earlier past action?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'They ___ here long before you joined the company.'",
    ...
    {
      question:
        "Which sentence correctly uses present perfect for an unspecified time?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'As soon as he ___, we will start the meeting.'",
    ...
    {
      question:
        "Which sentence correctly uses the future perfect continuous to emphasize duration?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'He said he ___ there since 2010.'",
    ...
    {
      question:
        "Which sentence correctly balances past continuous and simple past?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'By the time the seminar ends, we ___ for three hours.'",
    ...
    {
      question:
        "Which sentence correctly uses a reduced clause of reason?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'I ___ that report before the boss asked for it.'",
    ...
    {
      question:
        "Which sentence correctly uses a time marker with present perfect?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'They ___ discussions by the time I arrived.'",
    ...
    {
      question:
        "Which sentence correctly uses future perfect to show a deadline?",
      choices: [
    ...
    // 46 (FIXED: clearer sentence for 'has been forgetting')
    {
      question: "Choose the correct tense: 'He ___ forgetting his keys a lot lately.'",
      choices: ["was", "has", "is", "has been"],
      correctIndex: 3,
      explanation:
        "The adverb 'lately' suggests a recent and ongoing situation. The Present Perfect Continuous ('has been forgetting') is best for an action that started in the recent past and continues up to now."
    },
    // 47
    {
      question:
        "Which sentence correctly uses the structure 'used to' for past habits?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'He ___ in the office when his boss walked in.'",
    ...
    {
      question:
        "Choose the correct tense: 'He said that by 2020, he ___ here for ten years.'",
  ...
  super: [
    ...
    {
      question:
        "Identify the error in tense sequence: 'If I knew about the meeting, I would have attended yesterday.'",
      choices: ["If I knew", "would have attended", "yesterday", "no error"],
      correctIndex: 0,
      explanation:
    ...
    {
      question:
        "Choose the best revision: 'Had I know about the delay, I would not have rushed.'",
      choices: [
    ...
    {
      question:
        "Which sentence correctly uses a mixed conditional (present result of past action)?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'I would rather you ___ this matter with the manager yourself.'",
    ...
    {
      question:
        "Choose the correct tense: 'He speaks as if he ___ all the answers.'",
    ...
    {
      question:
        "Which sentence correctly uses the subjunctive after 'insist'?",
      choices: [
    ...
    {
      question:
        "Choose the correct verb form: 'The board recommended that the policy ___ immediately.'",
    ...
    {
      question:
        "Which sentence correctly uses inversion with a negative adverbial?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'Rarely ___ such dedication seen in a new employee.'",
    ...
    {
      question:
        "Which sentence correctly uses the future perfect for an earlier future action?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'Scarcely ___ we finished the work when the deadline was extended.'",
    ...
    {
      question:
        "Choose the correct tense: 'Despite ___ exhausted, she continued working.'",
    ...
    {
      question:
        "Which sentence correctly uses 'used to' versus 'be used to'?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'By the end of this year, I ___ here for fifteen years.'",
    ...
    {
      question:
        "Which sentence correctly uses a reduced relative clause in the present?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'He appears ___ the requirements already.'",
    ...
    {
      question:
        "Which sentence correctly uses the passive infinitive?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'If it were not for her guidance, I ___ lost.'",
    ...
    // 22 (FIXED: added 'been' in the passive)
    {
      question:
        "Choose the correct tense: 'No sooner ___ the announcement been made than the phones started ringing.'",
      choices: ["was", "has", "had", "being"],
      correctIndex: 2,
      explanation:
        "With 'No sooner' we use Past Perfect inversion: 'No sooner had the announcement been made than...'. The auxiliary 'had' comes before the subject."
    },
    // 23
    {
      question:
    ...
    {
      question:
        "Choose the correct tense: 'By this time tomorrow, we ___ the results.'",
    ...
    {
      question:
        "Which sentence correctly uses 'would rather' with the past perfect?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'Hardly ___ we reached the terminal when the bus left.'",
    ...
    {
      question:
        "Which sentence correctly uses the structure 'be about to'?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'She denied ___ anything wrong.'",
    ...
    {
      question:
        "Which sentence correctly uses the future perfect in a formal notice?",
      choices: [
    ...
    // 30 (FIXED: use gerund 'missing' as natural form)
    {
      question: "He regretted ___ the deadline.",
      choices: ["to miss", "missing", "to have missing", "to have missed"],
      correctIndex: 1,
      explanation:
        "After 'regret' we normally use a gerund (verb + ing) to refer to a past action: 'He regretted missing the deadline.' The other forms are unnatural or incorrect in this sentence."
    },
    // 31
    {
      question:
        "Which sentence correctly uses 'be to' for official arrangements?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'He treats me as though I ___ his assistant.'",
    ...
    {
      question:
        "Which sentence correctly uses a reduced adverbial clause of time?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'By the time you read this letter, I ___ abroad.'",
    ...
    {
      question:
        "Which sentence correctly uses a mixed conditional (present condition, past result)?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'Seldom ___ such commitment seen among new staff.'",
      choices: ["has", "have", "is", "was"],
      correctIndex: 0,
      explanation:
    ...
    {
      question:
        "Which sentence correctly expresses a wish about the present using 'would'?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'By next June, I ___ my Master's degree.'",
    ...
    {
      question:
        "Which sentence correctly uses 'be used to' with a gerund?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'If it had not been for his help, we ___ the project on time.'",
    ...
    {
      question:
        "Which sentence correctly uses 'was/were to have' to express an unreal plan?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'No sooner ___ the speech finished than the audience applauded.'",
    ...
    {
      question:
        "Which sentence correctly uses 'have' in a perfect conditional?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'The document is believed ___ lost.'",
    ...
    {
      question:
        "Which sentence correctly uses 'as though' with a past perfect to refer to an unreal past?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'At this rate, we ___ the project by the original deadline.'",
    ...
    {
      question:
        "Which sentence correctly uses inversion after 'little'?",
      choices: [
    ...
    {
      question:
        "Choose the correct tense: 'Had it not been for the traffic, we ___ on time.'",
    ...
    // 49 (FIXED: clarify it's present–future, not mixed conditional)
    {
      question:
        "Which sentence correctly shows a present condition and a future result?",
      choices: [
      ...
      correctIndex: 2,
      explanation:
        "This is a standard First Conditional: 'If + Simple Present, ... will + base verb'. A real present condition ('If he works harder') leads to a likely future result ('he will get promoted next year')."
    },
    // 50
    {
      question:
        "Choose the correct tense: 'Were he to ask for help, we ___ willing to support him.'",
