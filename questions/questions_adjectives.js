...
window.VERBAL_QUESTION_BANK["adjectives"] = {
  ...
  beginner: [
    ...
    { question: "Adjectives in 'small quiet town':", options: ["visited, town", "small, quiet", "we, town", "visited, quiet"], answer: "small, quiet", explanation: "Modifiers of town." }
  ],

  // LEVEL 2: INTERMEDIATE (50 Items)
  intermediate: [
    // Linking Verbs & Adverbs (1-10)
    ...
    { question: "Error ID: 'most cheapest'", options: ["This is", "the most", "cheapest", "in store"], answer: "cheapest", explanation: "Double superlative." },
    ...
    { question: "Placement of 'almost':", options: ["almost late", "late almost", "almost was late", "late for almost"], answer: "almost late", explanation: "Before adjective." },
  ...
  advanced: [
    // Tricky Linking/Adverbs (1-10)
    { question: "Error ID: 'She looked happily after her sick mother.'", options: ["She", "looked", "happily", "after"], answer: "happily", explanation: "Contextual: if meaning 'seemed happy', use 'happy'. If 'cared for', 'happily' is OK, but typically tested as linking verb error." },
  ...
  // LEVEL 4: EXPERT (50 Items - Super + Exam)
  expert: [
    // Error ID Style (1-10)
    { question: "Error ID: 'She is the most smartest.'", options: ["She is", "the most", "smartest", "in class"], answer: "smartest", explanation: "Double superlative." },
    { question: "Error ID: 'a few good advices'", options: ["He gave", "me", "a few good", "advices"], answer: "advices", explanation: "Uncountable." },
    { question: "Error ID: 'only few time'", options: ["There is", "only few", "time left", "deadline"], answer: "only few", explanation: "Should be 'little'." },
    { question: "Error ID: 'more importantest'", options: ["This is", "the more", "importantest", "issue"], answer: "importantest", explanation: "Double comparison." },
    { question: "Error ID: 'more friendlier'", options: ["She is", "more", "friendlier", "than"], answer: "more", explanation: "Redundant." },
    { question: "Error ID: 'less useful of three'", options: ["This is", "the less", "useful of", "the three"], answer: "the less", explanation: "Should be 'least'." },
    { question: "Error ID: 'more superior'", options: ["He is", "more", "superior", "than"], answer: "more", explanation: "Redundant." },
    { question: "Error ID: 'more elder'", options: ["She is", "more", "elder", "than"], answer: "more", explanation: "Redundant." },
    { question: "Error ID: 'more complete'", options: ["The report", "is", "more complete", "now"], answer: "more complete", explanation: "Absolute adjective." },
    { question: "Error ID: 'almost nearly'", options: ["She", "almost", "nearly", "missed"], answer: "nearly", explanation: "Redundant." },

    // Sentence Improvement (11-20)
    { question: "Improve: 'more kinder'", options: ["kinder", "more kind", "most kinder", "kindest"], answer: "kinder", explanation: "Standard." },
    { question: "Improve: 'most happiest'", options: ["happiest", "most happy", "happier", "more happiest"], answer: "happiest", explanation: "Standard." },
    { question: "Improve: 'elder than me'", options: ["older than me", "elder than", "more elder", "eldest"], answer: "older than me", explanation: "General age." },
    { question: "Improve: 'less expensive of three'", options: ["least expensive", "lesser expensive", "less expensive", "less most"], answer: "least expensive", explanation: "Superlative." },
    { question: "Improve: 'most talentedest'", options: ["most talented", "talentedest", "most talented singer", "talentedest singer"], answer: "most talented", explanation: "Standard." },
    { question: "Improve: 'more superior than'", options: ["superior to", "more superior to", "superior than", "most superior"], answer: "superior to", explanation: "Standard." },
    { question: "Improve: 'very best'", options: ["the best", "very best", "most best", "best"], answer: "the best", explanation: "Formal." },
    { question: "Improve: 'more prettier'", options: ["prettier", "more pretty", "most prettier", "prettiest"], answer: "prettier", explanation: "Standard." },
    { question: "Improve: 'most ideal'", options: ["ideal", "more ideal", "idealest", "most ideally"], answer: "ideal", explanation: "Absolute." },
    { question: "Improve: 'more complete'", options: ["complete", "most complete", "completer", "completely"], answer: "complete", explanation: "Absolute." },

    // Reading Context (21-30)
    { question: "Modify 'explanation': 'brief but clear'", options: ["He", "gave", "explanation", "brief but clear"], answer: "brief but clear", explanation: "Adjectives." },
    ...
    { question: "Adjective phrase: 'man with red hat'", options: ["with red hat", "man", "waved", "yesterday"], answer: "with red hat", explanation: "Describes man." },
    ...
    { question: "Main adjective: 'remained calm'", options: ["Facing", "difficult", "calm", "remained"], answer: "calm", explanation: "Predicate adj." },
    ...
    // Logic & Nuance (31-40)
    { question: "Place description: 'crowded and noisy'", options: ["crowded and noisy", "crowded and noisily", "crowdedly and noisy", "crowded noisily"], answer: "crowded and noisy", explanation: "Adjectives." },
    { question: "Placement: 'almost late'", options: ["almost late", "late almost", "almost was", "late for"], answer: "almost late", explanation: "Before adj." },
    { question: "Reduced clause: 'interested in'", options: ["Students interested", "Students who interested", "Students interest", "Students which"], answer: "Students interested", explanation: "Passive." },
    { question: "Usage: 'enough information'", options: ["enough information", "information enough", "enough have", "enough informations"], answer: "enough information", explanation: "Before noun." },
    { question: "Usage: 'too heavy'", options: ["too heavy", "heavy too", "heavy for too", "heavy too much"], answer: "too heavy", explanation: "Excess." },
    { question: "Usage: 'clear enough'", options: ["clear enough", "enough clear", "enough are", "clear for"], answer: "clear enough", explanation: "After adj." },
    { question: "Comparative: 'fairer'", options: ["more fairer", "fairer", "most fairer", "the fairer"], answer: "fairer", explanation: "Standard." },
    { question: "Usage: 'too young'", options: ["too much young", "too young", "young too much", "much too young not"], answer: "too young", explanation: "Standard." },
    { question: "Usage: 'such a'", options: ["such long", "such a long", "long such", "a such"], answer: "such a long", explanation: "Pattern." },
    { question: "Complement: 'satisfactory'", options: ["satisfactory", "satisfactorily", "satisfaction", "satisfyingness"], answer: "satisfactory", explanation: "Adj." },

    // Mixed Final (41-50)
    { question: "Correct sentence:", options: ["more friendlier", "friendlier", "most friendlier", "friendliest"], answer: "friendlier", explanation: "Standard." },
    ...
    { question: "Use 'fewer':", options: ["less problems", "fewer problems", "less problem", "many less"], answer: "fewer problems", explanation: "Countable." },
    ...
    { question: "Adjective phrase:", options: ["in blue shirt", "in blue", "blue shirt", "with blue"], answer: "in blue shirt", explanation: "Modifier." },
