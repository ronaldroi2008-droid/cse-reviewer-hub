...
window.VERBAL_QUESTION_BANK["articles"] = {
  ...
  super: [
    ...
    {
      question: "He has ___ flu.",
      options: ["a", "an", "the", "-"],
      answer: "the",
      explanation: "With common infections like 'flu' or 'measles', we traditionally use 'the' (the flu, the measles). However, modern usage sometimes drops it, but 'the' is historically correct."
    },
    {
      question: "He has ___ cancer.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Serious diseases (Cancer, Diabetes, Heart Disease) generally take NO article."
    },
    {
      question: "She caught ___ cold.",
      options: ["a", "an", "the", "-"],
      answer: "a",
      explanation: "We say 'a cold' or 'a headache' (common ailments)."
    },
    {
      question: "I have ___ headache.",
      options: ["a", "an", "the", "-"],
      answer: "a",
      explanation: "Common ailment = 'a'."
    },
    {
      question: "He suffers from ___ asthma.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Chronic medical conditions usually take no article."
    },
    {
      question: "She has ___ toothache.",
      options: ["a", "an", "the", "-"],
      answer: "a",
      explanation: "Aches (toothache, stomachache) often take 'a'."
    },
    {
      question: "___ mumps is a painful disease.",
      options: ["A", "An", "The", "-"],
      answer: "The",
      explanation: "Like 'the measles', 'the mumps' often takes 'the' in traditional English."
    },
    {
      question: "He had ___ heart attack.",
      options: ["a", "an", "the", "-"],
      answer: "a",
      explanation: "Specific medical event = 'a'."
    },
    {
      question: "___ pneumonia is dangerous.",
      options: ["A", "An", "The", "- (No article)"],
      answer: "- (No article)",
      explanation: "Serious/Scientific disease names = No article."
    },
    {
      question: "He has ___ high blood pressure.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Medical condition = No article."
    },

    // 11-20: Meals
    {
      question: "We had ___ breakfast at 7 AM.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "We do not use articles with names of meals (breakfast, lunch, dinner) when speaking generally."
    },
    {
      question: "It was ___ delicious breakfast.",
      options: ["a", "an", "the", "-"],
      answer: "a",
      explanation: "When we describe the meal with an adjective (delicious, good), we use 'a'."
    },
    {
      question: "___ dinner we had last night was great.",
      options: ["A", "An", "The", "-"],
      answer: "The",
      explanation: "We use 'The' because we are specifying *which* dinner (the one last night)."
    },
    {
      question: "Did you have ___ lunch?",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "General meal = No article."
    },
    {
      question: "They invited us to ___ dinner.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "General meal = No article."
    },
    {
      question: "He made ___ nice lunch for us.",
      options: ["a", "an", "the", "-"],
      answer: "a",
      explanation: "Adjective + Meal = 'a'."
    },
    {
      question: "___ lunch is ready.",
      options: ["A", "An", "The", "- (No article)"],
      answer: "- (No article)",
      explanation: "General announcement of the meal."
    },
    {
      question: "I don't eat ___ supper.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "General habit."
    },
    {
      question: "After ___ tea, we went out.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Referring to the meal time (British usage)."
    },
    {
      question: "The wedding feast was ___ dinner to remember.",
      options: ["a", "an", "the", "-"],
      answer: "a",
      explanation: "Describing it as 'a specific type' of dinner."
    },

    // 21-30: Transport and Communication
    {
      question: "We went there by ___ car.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "When using 'by' + transport (by car, by bus, by train), we use NO article."
    },
    {
      question: "We went in ___ car.",
      options: ["a", "an", "the", "-"],
      answer: "a",
      explanation: "When using 'in' or 'on', we MUST use an article (in a car, on a bus)."
    },
    {
      question: "She travels by ___ train.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "By + transport = No article."
    },
    {
      question: "He is on ___ bus.",
      options: ["a", "an", "the", "-"],
      answer: "a",
      explanation: "Preposition 'on' requires an article (usually 'the' if specific, or 'a')."
    },
    {
      question: "Contact me by ___ email.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Means of communication using 'by' takes no article."
    },
    {
      question: "I heard it on ___ radio.",
      options: ["a", "an", "the", "-"],
      answer: "the",
      explanation: "Media usually takes 'the' (the radio, the internet). Exception: TV."
    },
    {
      question: "I saw it on ___ TV.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Exception! We say 'on TV' or 'on television' without an article. But we say 'on the radio'."
    },
    {
      question: "Turn off ___ television.",
      options: ["a", "an", "the", "-"],
      answer: "the",
      explanation: "Here we mean the physical device/machine, so we use 'the'."
    },
    {
      question: "He goes to school on ___ foot.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Idiom: 'On foot' (walking) takes no article."
    },
    {
      question: "She arrived by ___ taxi.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "By + transport = No article."
    },

    // 31-40: Special Locations
    {
      question: "The criminal was sent to ___ prison.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "When going for the institution's primary purpose (to be a prisoner), we use NO article."
    },
    {
      question: "The lawyer went to ___ prison to meet his client.",
      options: ["a", "an", "the", "-"],
      answer: "the",
      explanation: "The lawyer is a visitor, not a prisoner, so he goes to 'the' specific building."
    },
    {
      question: "He had an accident and was taken to ___ hospital.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "In British English, 'to hospital' (as a patient) takes no article. (Note: American English often uses 'the')."
    },
    {
      question: "I went to ___ hospital to visit my aunt.",
      options: ["a", "an", "the", "-"],
      answer: "the",
      explanation: "Visitor = 'the'."
    },
    {
      question: "She is studying at ___ university.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Function of studying = No article."
    },
    {
      question: "The package was delivered to ___ university.",
      options: ["a", "an", "the", "-"],
      answer: "the",
      explanation: "Specific location/building = 'The'."
    },
    {
      question: "Children go to ___ bed at 9 PM.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Purpose of sleeping = No article."
    },
    {
      question: "Don't jump on ___ bed.",
      options: ["a", "an", "the", "-"],
      answer: "the",
      explanation: "Physical furniture = 'The'."
    },
    {
      question: "He is in ___ class.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Attending a lesson."
    },
    {
      question: "The meeting is in ___ Class 3B.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Proper names of rooms/classes usually take no article."
    },

    // 41-50: Unique Idioms and Exceptions
    {
      question: "He was appointed ___ chairman.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Verbs like 'appoint', 'elect', or 'make' usually take NO article before the unique title/position."
    },
    {
      question: "They elected him ___ President.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Unique role following 'elect' takes no article."
    },
    {
      question: "___ Queen Elizabeth was famous.",
      options: ["A", "An", "The", "- (No article)"],
      answer: "- (No article)",
      explanation: "Title + Name (Queen Elizabeth, Doctor Smith, President Lincoln) takes NO article."
    },
    {
      question: "___ Queen visited the city.",
      options: ["A", "An", "The", "-"],
      answer: "The",
      explanation: "Title alone (without the name) takes 'The'."
    },
    {
      question: "I like ___ spring.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Seasons (spring, summer) generally take no article, though 'the spring' is also possible. Zero is common for general statements."
    },
    {
      question: "In ___ 1990s.",
      options: ["a", "an", "the", "-"],
      answer: "the",
      explanation: "Decades take 'The' (The 90s, The 1990s)."
    },
    {
      question: "He plays ___ Romeo in the play.",
      options: ["a", "an", "the", "- (No article)"],
      answer: "- (No article)",
      explanation: "Names of characters/people take no article."
    },
    {
      question: "Do you have ___ Sherlock Holmes in your library?",
      options: ["a", "an", "the", "-"],
      answer: "a",
      explanation: "Idiom: This means 'A copy of a book by/about Sherlock Holmes', not the person himself."
    },
    {
      question: "___ man is a social animal.",
      options: ["A", "An", "The", "- (No article)"],
      answer: "- (No article)",
      explanation: "When 'Man' refers to the human species/mankind, we use NO article."
    },
    {
      question: "___ Hague is a city in the Netherlands.",
      options: ["A", "An", "The", "-"],
      answer: "The",
