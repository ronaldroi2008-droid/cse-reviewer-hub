...
error_identification: {
  ...
  <section class="lesson-section">
    ...
    <p>These three are all over the Civil Service Exam, especially in sentence construction and error identification.</p>
  </section>
  ...
  <section class="lesson-section">
    ...
    <h4>d) NOR – negative choice (usually after "neither" or a negative)</h4>
    <ul>
    ...
    <p>More formal; in everyday speech we usually use <strong>because</strong>, but <strong>for</strong> can appear in exams.</p>
    ...
    <p>
      When a coordinating conjunction joins <strong>two full clauses</strong> (each with its own subject and verb),
      use a <strong>comma</strong> before the conjunction.
    </p>
    <p>
    ...
    <div class="highlight-box">
      <p><strong>✅ Correct:</strong> <em>He wanted to pass the exam, so he studied every night.</em></p>
      <p><strong>❌ Comma splice / error:</strong> <em>He wanted to pass the exam, he studied every night.</em></p>
      <p><strong>Fix:</strong> add <strong>and/so</strong>, or use a semicolon or period.</p>
    </div>
  </section>
  ...
  <section class="lesson-section">
    ...
    <p>
      ...
      The subordinate clause <strong>cannot stand alone</strong>.
    </p>
    ...
    <p>A subordinating conjunction can come at the <strong>beginning</strong> or in the <strong>middle</strong> of a sentence.</p>
    ...
    <p>
      <strong>Rule:</strong> If the sentence <strong>starts</strong> with the subordinate clause → add a <strong>comma</strong> after it.
      If the main clause comes first → usually <strong>no comma</strong>.
    </p>

    <h3>4.3 Common Mistake: Double Conjunctions</h3>
    <p><strong>❌ Wrong:</strong> <em>Because he was sick, so he stayed home.</em></p>
    <p><strong>✅ Correct (choose only one connector):</strong></p>
    <ul>
  ...
  <section class="lesson-section">
    ...
    <ul>
      ...
      <li>
        <strong>Not only … but also</strong> – emphasizes two positives<br />
    ...
    <p>
      With correlative conjunctions, the words after each part should be
      <strong>similar in form (parallel)</strong>.
    </p>

    <div class="highlight-box">
      <p><strong>Check for parallelism:</strong></p>
      <ul>
        <li>
          ❌ <em>She is not only <strong>smart</strong> but also <strong>works hard</strong>.</em><br />
          ✔ <em>She is not only <strong>smart</strong> but also <strong>hardworking</strong>.</em><br />
          ✔ <em>She not only <strong>studies hard</strong> but also <strong>works part-time</strong>.</em>
        </li>
        <li>
          ❌ <em>He likes either <strong>to read</strong> or <strong>watching movies</strong>.</em><br />
          ✔ <em>He likes either <strong>to read</strong> or <strong>to watch movies</strong>.</em><br />
          ✔ <em>He likes either <strong>reading</strong> or <strong>watching movies</strong>.</em>
        </li>
        <li>
          ❌ <em>They are both <strong>honest</strong> and <strong>with talent</strong>.</em><br />
          ✔ <em>They are both <strong>honest</strong> and <strong>talented</strong>.</em>
        </li>
      </ul>
    </div>
  </section>
  ...
  <section class="lesson-section">
    <h2>6. Common Exam Patterns & Quick Checklist</h2>

    <h3>6.1 Typical Question Types</h3>
    <ul>
      <li><strong>Sentence improvement:</strong> choose the best connector (although vs but vs because vs so).</li>
      <li><strong>Error identification:</strong> double conjunctions (<em>because … so</em>), wrong pair (<em>either … nor</em>), faulty parallelism.</li>
      <li><strong>Sentence completion:</strong> pick the conjunction that shows correct logic (cause, contrast, condition, result).</li>
    </ul>

    <h3>6.2 Quick Checklist Before Choosing an Answer</h3>
    <ul class="check-list">
      <li>Is the relationship <strong>addition, contrast, cause, result, time, or condition</strong>? Choose a conjunction that matches the logic.</li>
      <li>For FANBOYS, check: Are there <strong>two full clauses</strong>? If yes, a comma is usually needed before the conjunction.</li>
      <li>For subordinating conjunctions, avoid <strong>double connectors</strong> like "Because … so".</li>
      <li>For correlative conjunctions, check if the structure after each part is <strong>parallel</strong>.</li>
      <li>Read the sentence with and without the conjunction. Does the meaning stay clear and logical?</li>
    </ul>

    <p><strong>Exam tip:</strong> When confused between two conjunctions, ask yourself: <em>"Am I showing a reason (because), a result (so), or a contrast (but/although)?"</em> That usually reveals the correct answer.</p>
  </section>
  `
},

words_often_confused: {
  title: "Words Often Confused – Correct Usage in Context",

  intro:
    "In English, many words look or sound similar but have different meanings and uses. These are called 'words often confused.' In the Civil Service Exam, you will often be asked to choose the correct word to complete a sentence, or to find an error in usage. To answer these items, you must know both the meaning and the function (part of speech) of each word, and then match it to the sentence context.",

  keyPoints: [
    // 1. What “words often confused” means
    "Words often confused are pairs or groups of words that are similar in spelling or pronunciation, but different in meaning, function, or usage.",
    "Common examples include: accept/except, affect/effect, advice/advise, borrow/lend, its/it’s, their/there/they’re, than/then, and many more.",
    "",

    // 2. How exams usually test them
    "In exams, these words are tested through sentence completion (choosing the correct word for the blank), error identification, and sentence improvement questions.",
    "Sometimes all the choices are spelled correctly, but only one fits the meaning and grammar of the sentence.",
    "",

    // 3. Strategy: meaning + part of speech + context
    "Always ask two questions: (1) What does this word mean? (2) What part of speech is needed in this blank (noun, verb, adjective, adverb, pronoun, preposition)?",
    "Look at the words before and after the blank. The grammar pattern will tell you whether you need a noun, verb, adjective, or preposition.",
    "Check for time (past/present), quantity (singular/plural), and logic (Does the sentence talk about receiving, excluding, comparing, etc.?).",
    "",

    // 4. Memory aids and patterns
    "Use simple memory tricks: AFFECT = Action (verb), EFFECT = End result (noun); ACCEPT = receive, EXCEPT = exclude.",
    "Contracted forms (it’s, they’re, who’s) always expand to two words (it is/it has, they are, who is/who has). If the sentence does not allow that expansion, use the non-contracted form (its, their, whose).",
    "Comparisons usually use than; time or sequence ideas often use then.",
    "",

    // 5. Exam mindset
    "Do not answer based on sound alone. Many confusing words are homophones (same sound, different spelling).",
    "If two choices seem acceptable, read the sentence slowly again. One will fit the exact meaning and grammar more precisely.",
    "Practice with the most common pairs until their meanings and patterns become automatic."
  ],

  patterns: [
    "Choosing between similar-looking words based on meaning: accept vs except, affect vs effect, principal vs principle, stationary vs stationery.",
    "Choosing between verb and noun forms: advice (noun) vs advise (verb); practice (noun) vs practise (verb in some varieties).",
    "Distinguishing possessives and contractions: its vs it’s; whose vs who’s; their vs there vs they’re.",
    "Choosing the correct word in comparison and sequence: than vs then; fewer vs less; good vs well.",
    "Choosing the correct preposition or small function word: among vs between; beside vs besides; may be vs maybe.",
    "Identifying and correcting wrong word usage in an underlined portion of a sentence."
  ],

  examples: [
    {
      q: "Choose the correct word: I cannot _____ your excuse for being late.",
      choices: ["except", "accept", "effect", "advise"],
      answer: "accept",
      explanation:
        "The sentence needs a verb that means “receive” or “agree to.” Accept is a verb meaning “to receive” or “to agree to.” Except is usually a preposition meaning “excluding,” so it does not fit. Effect is a noun (result), and advise is a different verb (to give advice)."
    },
    {
      q: "Choose the correct word: Lack of sleep can deeply _____ your performance at work.",
      choices: ["affect", "effect", "except", "accept"],
      answer: "affect",
      explanation:
        "We need a verb meaning “to influence.” Affect is usually a verb meaning “to influence.” Effect is usually a noun meaning “result.” Therefore, lack of sleep affects (influences) your performance."
    },
    {
      q: "Choose the correct word: Thank you for your helpful _____.",
      choices: ["advise", "advice", "adviced", "advising"],
      answer: "advice",
      explanation:
        "After the adjective helpful, we need a noun. Advice is a noun meaning “suggestion or recommendation.” Advise is a verb, so it cannot follow the article your in this pattern. Adviced is not a correct form, and advising is a gerund/participle, not the best choice here."
    },
    {
      q: "Choose the correct sentence:",
      choices: [
        "Can I borrow you your pen?",
      ...
      explanation:
        "Borrow means to take something from someone; lend means to give something to someone. The person speaking wants the other person to give the pen, so the correct pattern is “Can you lend me your pen?” We do not say “borrow you your pen” or “borrow me your pen.”"
    },
    {
      q: "Choose the correct word: Please _____ this letter to the HR office.",
      choices: ["bring", "take", "accept", "advise"],
      answer: "take",
      explanation:
        "Bring suggests movement toward the speaker or toward the present place. Take suggests movement away from the speaker to another place. The sentence suggests carrying the letter from here to the HR office (away from the speaker), so take is the correct word."
    },
    {
      q: "Choose the correct form: The dog wagged _____ tail when it saw its owner.",
      choices: ["its", "it’s", "it is", "it has"],
      answer: "its",
      explanation:
        "We need a possessive form showing that the tail belongs to the dog. Its (without apostrophe) is the possessive pronoun. It’s is a contraction for “it is” or “it has,” which does not fit the sentence pattern: “The dog wagged it is tail” is incorrect."
    },
    {
      q: "Choose the correct word: _____ going to be late because of the traffic.",
      choices: ["Their", "There", "They’re", "They are"],
      answer: "They’re",
      explanation:
        "We need a subject pronoun + verb meaning “they are.” They’re is the contraction of they are. Their is possessive (their car), and there is used for place or as an introductory word (There are many cars on the road). “They are” also fits but is not contracted; in most exams, the contraction is preferred when offered as the best match to the blank."
    },
    {
      q: "Choose the correct word: She is taller _____ her younger brother.",
      choices: ["then", "than", "that", "there"],
      answer: "than",
      explanation:
        "The sentence makes a comparison (taller than). Than is used for comparisons. Then is used for time or sequence (We ate dinner, then we watched TV). That and there do not fit the grammar of the comparison structure."
    },
    {
      q: "Choose the correct sentence:",
      choices: [
        "There is many reasons for this decision.",
        "Their many reasons for this decision.",
        "They’re many reasons for this decision.",
        "There are many reasons for this decision."
      ],
      answer: "There are many reasons for this decision.",
      explanation:
        "The real subject is reasons, which is plural, so the verb must be are, not is. There is the correct introductory word here (There are…). Their is possessive (their reasons), and they’re is a contraction of “they are,” which does not match the pattern of the sentence."
    },
    {
      q: "Choose the correct option: I have _____ finished the report; I can relax now.",
      choices: ["all ready", "already", "allready", "all-ready"],
      answer: "already",
      explanation:
        "Already means “by this time” or “earlier than expected.” It fits the meaning: the report is finished now. All ready means “completely ready” (Everyone is all ready to go.), which does not match the idea of finishing something in the past."
    }
  ],

  quickTips: [
    "Do not rely on sound alone. Many confusing words are homophones (they sound the same but are spelled differently).",
    "Always check what part of speech is needed in the blank: noun, verb, adjective, adverb, pronoun, or preposition.",
    "Remember: AFFECT (verb) vs EFFECT (noun); ACCEPT (receive) vs EXCEPT (excluding).",
    "Contractions (it’s, they’re, who’s) always expand to two words (it is/it has, they are, who is/who has). If you cannot expand it naturally, use the non-contracted form (its, their, whose).",
    "Use THAN for comparisons (bigger than, more than) and THEN for time or sequence (first…, then…).",
    "Borrow from someone; lend to someone. You borrow a book; the library lends you a book.",
    "If two options look correct, reread the whole sentence slowly. Choose the word that fits both the meaning and the grammar pattern exactly.",
    "Make a personal list of confusing word pairs that you often miss and review them regularly before the exam."
  ]
},
...
// ==========================================
  ...
  // ---------------------------
    ...
    switch (topic) {
      ...
      case "ratio": return (typeof RATIO_QUESTIONS !== 'undefined') ? RATIO_QUESTIONS : null;
      ...
      case "wp_distance": return (typeof WP_DISTANCE_QUESTIONS !== 'undefined') ? WP_DISTANCE_QUESTIONS : null;
      default: return null;
    }
  }
}
