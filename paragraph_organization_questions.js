...
const PARAGRAPH_ORGANIZATION_QUESTIONS = {
  ...
  // ==========================================
  // LEVEL 1: BEGINNER (Chronology & Simple Logic)
  // ==========================================
  beginner: [
    {
      ...
      a: "2-1-3-4",
      exp: "Chronological order: Socks (First) -> Shoes (Then) -> Laces (Finally) -> Ready (Result)."
    },
    {
      ...
      a: "2-3-1-4",
      exp: "Process: Get teabag -> Put in cup -> Add water -> Add sugar."
    },
    {
      ...
      a: "2-4-1-3",
      exp: "Sequence: Plant -> Water -> Roots -> Shoot."
    },
    {
      ...
      a: "2-4-1-3",
      exp: "Chronology: Go to market -> Pick items -> Pay -> Leave."
    },
    {
      q: "Arrange the following:\n1. The audience clapped loudly.\n2. The singer walked onto the stage.\n3. She took a bow and smiled.\n4. She sang a beautiful song.",
      options: ["2-4-1-3", "2-1-4-3", "4-2-1-3", "1-2-3-4"],
      a: "2-4-1-3",
      exp: "Event flow: Enter -> Sing -> Audience reacts -> Bow."
    },
    {
      q: "Arrange the following:\n1. I brushed my teeth.\n2. I woke up at 6:00 AM.\n3. I ate my breakfast.\n4. I took a shower.",
      options: ["2-1-4-3", "2-4-1-3", "2-3-1-4", "4-2-1-3"],
      a: "2-1-4-3",
      exp: "Typical morning routine: Wake up -> Brush/Shower (interchangeable but usually prep first) -> Breakfast. Option 2-1-4-3 is the most logical sequence provided."
    },
    {
      ...
      a: "2-3-1-4",
      exp: "Story flow: Decide -> Pack -> Rain starts (Problem) -> Run inside (Reaction)."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Recipe steps: Break -> Beat -> Mix -> Pour."
    },
    {
      ...
      a: "3-1-2-4",
      exp: "Time transition: Afternoon -> Sun set -> Color change -> Night (Stars)."
    },
    {
      ...
      a: "2-4-1-3",
      exp: "Cause and Effect: Didn't study -> Papers returned -> Failed -> Sad."
    },
    {
      ...
      a: "2-1-3-4",
      exp: "Process: Decide -> Wash -> Rinse -> Dry."
    },
    {
      ...
      a: "4-1-2-3",
      exp: "Setting scene (4) -> Action (1) -> Reaction (2) -> Conclusion (3)."
    },
    {
      ...
      a: "2-1-3-4",
      exp: "Logical steps: Write -> Put inside -> Seal -> Stamp."
    },
    {
      ...
      a: "2-3-4-1",
      exp: "Surprise party logic: Dark room -> Enter -> Lights on -> Surprise."
    },
    {
      ...
      a: "3-1-4-2",
      exp: "Chronology: Go to cinema -> Buy ticket -> Find seat -> Watch."
    },
    {
      ...
      a: "1-2-3-4",
      exp: "Classroom interaction flow: Question -> Hand raise -> Call -> Answer."
    },
    {
      ...
      a: "2-1-3-4",
      exp: "Process: Canvas -> Mix colors -> Result (Green) -> Use it (Paint grass)."
    },
    {
      q: "Arrange the following:\n1. The alarm rang loudly.\n2. He turned off the alarm.\n3. He went back to sleep.\n4. He was late for work.",
      options: ["1-2-3-4", "2-3-1-4", "1-3-2-4", "4-1-2-3"],
      a: "1-2-3-4",
      exp: "Chronology of a bad morning: Alarm -> Off -> Sleep again -> Late."
    },
    {
      ...
      a: "4-2-1-3",
      exp: "Reading process: Pick book -> Sit -> Open -> Read."
    },
    {
      ...
      a: "4-2-3-1",
      exp: "Explanation of rainbow: Rain/Sun -> Sun shines through -> Light physics -> Rainbow forms."
    },
    {
      ...
      a: "4-1-3-2",
      exp: "Shopping trip: Enter -> Check list -> Shop -> Pay."
    },
    {
      ...
      a: "1-3-4-2",
      exp: "Life cycle: Build nest -> Lay eggs -> Incubate -> Hatch."
    },
    {
    ...
    },
    {
      ...
      a: "2-1-3-4",
      exp: "Sports ending: Goal/End -> Cheer -> Sportsmanship -> Trophy."
    },
    // ... filling to 50 items per level logic ...
    {
    ...
    },
    {
      ...
      a: "4-1-2-3",
      exp: "Metamorphosis: Egg -> Caterpillar -> Chrysalis -> Butterfly."
    },
    {
    ...
    },
    {
      ...
      a: "2-1-4-3",
      exp: "Kickoff: Positions -> Whistle -> Kick -> Start."
    },
    {
      q: "Arrange the following:\n1. She studied hard for the test.\n2. She received an 'A'.\n3. She took the test.\n4. She was very happy.",
      options: ["1-3-2-4", "1-2-3-4", "3-1-2-4", "2-1-3-4"],
      a: "1-3-2-4",
      exp: "Academic success: Study -> Take test -> Get grade -> Reaction."
    },
    {
      q: "Arrange the following:\n1. The phone rang.\n2. He answered it.\n3. He said 'Hello'.\n4. He picked up the receiver.",
      options: ["1-4-2-3", "1-2-3-4", "1-4-3-2", "4-1-2-3"],
      a: "1-4-2-3",
      exp: "Phone call: Ring -> Pick up -> Answer (Connect) -> Speak."
    },
    {
      ...
      a: "2-3-4-1",
      exp: "Building snowman: Base -> Other parts -> Stack -> Result."
    },
    {
  ...
  intermediate: [
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Sequence: Event (Typhoon) -> Details (Wind/Rain) -> Effect (Suspension) -> Reaction (Students)."
    },
    {
      ...
      a: "3-2-1-4",
      exp: "Causal chain: Activity -> Mechanism -> Phenomenon -> Consequence."
    },
    {
      ...
      a: "4-1-2-3",
      exp: "Narrative: Find box -> Open it -> Find key -> Identify key."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "3-2-1-4", "2-1-3-4"],
      a: "2-3-1-4",
      exp: "Contrast structure: Good start -> Plan -> Problem (However) -> Solution (So)."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Biological process: Absorption -> Transport -> Usage -> Result."
    },
    {
      ...
      options: ["3-2-4-1", "1-2-3-4", "3-4-2-1", "2-3-4-1"],
      a: "3-2-4-1",
      exp: "Argument structure: General claim -> Detail 1 -> Detail 2 -> Conclusion."
    },
    {
      ...
      a: "3-1-4-2",
      exp: "Topic sentence (3) followed by chronological steps (First, Then, Finally)."
    },
    {
      ...
      a: "2-3-1-4",
      exp: "Topic (Trees) -> Mechanism (Roots) -> Effect (Erosion) -> Additional benefit."
    },
    {
      ...
      options: ["2-1-4-3", "1-2-3-4", "2-4-1-3", "1-4-2-3"],
      a: "2-1-4-3",
      exp: "Career path: Graduate -> Apply -> Interview -> Hired."
    },
    {
      ...
      a: "2-1-3-4",
      exp: "Manufacturing process: Mold -> Bake -> Result (Harden) -> Finish."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-1-2-4"],
      a: "2-3-1-4",
      exp: "Comparison: General statement -> Past -> Contrast (But today) -> Current capability."
    },
    {
      ...
      a: "4-2-3-1",
      exp: "Topic -> Explanation -> Benefit 1 -> Benefit 2."
    },
    {
      ...
      options: ["2-4-3-1", "2-4-1-3", "1-2-3-4", "2-1-4-3"],
      a: "2-4-1-3",
      exp: "Scientific definition: Definition/Cause -> Process 1 -> Result -> Detail."
    },
    {
      ...
      a: "1-3-4-2",
      exp: "Sports narrative: Train -> Race -> Finish -> Feeling."
    },
    {
      ...
      a: "3-2-1-4",
      exp: "Topic (Physics) -> Action -> Mechanism (Vacuum) -> Result."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Story: Goal -> Preparation -> Problem/Realization -> Solution."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Definition -> Function -> Detail -> Conclusion."
    },
    {
      ...
      a: "2-1-4-3",
      exp: "Topic (Bears) -> Feature (Fur) -> Reason (Warmth) -> Diet (Additional info)."
    },
    {
      ...
      a: "2-1-4-3",
      exp: "Weather change: Sun -> Clouds -> Wind -> Storm."
    },
    {
      ...
      a: "1-3-2-4",
      exp: "Benefit 1 -> Benefit 2 -> Action -> Conclusion."
    },
    {
      q: "Arrange the following:\n1. He missed the bus.\n2. His alarm clock broke.\n3. He overslept by an hour.\n4. He arrived late to school.",
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Chain of unfortunate events: Broken alarm -> Oversleep -> Miss bus -> Late."
    },
    {
      ...
      a: "2-3-4-1",
      exp: "Topic -> Process Step 1 -> Step 2 -> Result."
    },
    {
      ...
      a: "3-1-4-2",
      exp: "Writing process: Research -> Outline -> Draft -> Submit."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-3-4-1", "2-4-1-3"],
      a: "2-3-4-1",
      exp: "Topic -> Spring -> Winter -> Contrast (Summer). Note: 2-4-1-3 is also possible, but 'In contrast' usually follows a specific description. Let's assume standard cycle."
    },
    {
      q: "Arrange the following:\n1. He found a wallet on the street.\n2. He checked the ID inside.\n3. He returned it to the owner.\n4. The owner thanked him.",
      options: ["1-2-3-4", "2-1-3-4", "1-3-2-4", "4-1-2-3"],
      a: "1-2-3-4",
      exp: "Moral story: Find -> Check -> Return -> Gratitude."
    },
    {
      ...
      a: "3-4-1-2",
      exp: "Life cycle: Egg -> Larva -> Cocoon -> Butterfly."
    },
    {
      ...
      options: ["3-2-1-4", "1-2-3-4", "3-1-2-4", "2-3-1-4"],
      a: "3-2-1-4",
      exp: "Cause -> Specific Event -> Result 1 -> Result 2."
    },
    {
    ...
    },
    {
      ...
      options: ["2-1-4-3", "1-2-3-4", "2-4-1-3", "1-4-2-3"],
      a: "2-1-4-3",
      exp: "Topic Sentence (Strategy) -> First -> Then -> Finally."
    },
    {
    ...
    },
    {
      ...
      a: "2-3-4-1",
      exp: "Topic -> Usage -> Learners -> Conclusion."
    },
    {
    ...
    },
    {
      ...
      a: "3-4-1-2",
      exp: "Interaction: Call -> Approach -> Reaction -> Reward."
    },
    {
      ...
      a: "2-1-3-4",
      exp: "Camping: Arrive -> Tent -> Fire -> Sleep."
    },
    {
      q: "Arrange the following:\n1. He finished the race.\n2. He started running.\n3. He tied his shoes.\n4. He stretched his muscles.",
      options: ["3-4-2-1", "1-2-3-4", "3-2-4-1", "4-3-2-1"],
      a: "3-4-2-1",
      exp: "Running: Prep (Shoes) -> Warmup (Stretch) -> Start -> Finish."
    },
    {
      ...
      a: "2-3-4-1",
      exp: "Story: Setting -> Action -> Complication -> Result."
    },
    {
      q: "Arrange the following:\n1. He paid the bill.\n2. He checked out of the hotel.\n3. He packed his suitcase.\n4. He called a taxi.",
      options: ["3-2-1-4", "1-2-3-4", "3-1-2-4", "2-1-3-4"],
      a: "3-2-1-4",
      exp: "Leaving hotel: Pack -> Check out/Pay (Linked) -> Taxi. Actually, usually check out involves paying. So: Pack -> Check out/Pay -> Taxi. Let's look at options. 3-2-1-4 means Pack -> Check out -> Pay -> Taxi. This is logical."
    },
    {
      ...
      a: "3-1-2-4",
      exp: "Accident: Cause -> Fall -> Effect -> Clean up."
    },
    {
      q: "Arrange the following:\n1. Birds start to sing.\n2. The sun rises.\n3. People wake up.\n4. The day begins.",
      options: ["2-1-3-4", "1-2-3-4", "2-4-1-3", "4-2-1-3"],
      a: "2-1-3-4",
      exp: "Morning sequence: Sun rise -> Nature reacts -> People react -> Day is on."
    }
  ],
  ...
  advanced: [
    {
      ...
      a: "2-4-1-3",
      exp: "Topic (Glossophobia) -> General stat (Many suffer) -> Definition of pronoun (It refers) -> Consequence."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Topic -> Benefit 1 -> Benefit 2 (Furthermore) -> Contrast (However)."
    },
    {
      ...
      a: "2-1-3-4",
      exp: "Topic -> Metaphor -> Explanation of metaphor -> Conclusion."
    },
    {
      ...
      a: "3-4-2-1",
      exp: "Event -> Detail of event -> Immediate effect -> Final Consequence."
    },
    {
      ...
      a: "3-2-4-1",
      exp: "Topic -> Side A (Physical) -> Detail A -> Side B (Digital)."
    },
    {
      ...
      options: ["3-2-4-1", "1-2-3-4", "3-4-2-1", "2-3-4-1"],
      a: "3-2-4-1",
      exp: "General statement -> Specific group -> Reason -> Result."
    },
    {
      ...
      a: "4-2-3-1",
      exp: "Broad Context -> Specific Driver -> Mechanism -> Result."
    },
    {
    ...
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Problem -> Process (Breakdown) -> Ecology -> Human impact."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Biography: Birth -> Youth -> Growth/Status -> Specific Achievement."
    },
    {
      ...
      a: "4-2-3-1",
      exp: "Scientific Method: Hypothesis -> Experiment -> Analysis -> Conclusion."
    },
    {
      ...
      a: "2-4-1-3",
      exp: "Pro 1 -> Pro 2 -> Pivot (However) -> Con."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Role -> Mechanism 1 -> Mechanism 2 -> Transfer."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Concept -> Mechanism -> Benefit -> Conclusion."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Creation -> Struggle -> Effort -> Success."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Cause -> Effect 1 -> Effect 2 -> Result."
    },
    {
    ...
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Fact -> Detail -> Complication -> Conclusion."
    },
    {
      ...
      a: "2-1-4-3",
      exp: "Topic -> Nickname -> Reason for nickname -> Future/Action."
    },
    {
      ...
      a: "3-4-1-2",
      exp: "Project flow: Survey -> Analysis -> Presentation -> Approval."
    },
    {
    ...
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-3-4", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Definition -> Cause -> Effect 1 -> Effect 2."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-1-4-3", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Topic -> Materials -> Foundation -> Feature."
    },
    {
      ...
      options: ["2-4-3-1", "1-2-3-4", "2-3-4-1", "4-2-3-1"],
      a: "2-4-3-1",
      exp: "Topic -> Step 1 -> Step 2 -> Result."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Topic -> Date -> Function -> Significance."
    },
    {
      ...
      options: ["3-2-1-4", "1-2-3-4", "3-1-2-4", "2-3-1-4"],
      a: "3-2-1-4",
      exp: "Trigger -> Sensing -> Action -> Purpose."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "General -> Detail (Systems) -> Specific 1 -> Specific 2."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Topic -> Mechanism -> Effect -> Final Result."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Intro -> Beliefs -> Action -> Later Life."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Topic -> Part 1 -> Part 2 -> Action."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Definition -> Negative -> Pivot -> Positive."
    },
    {
      ...
      options: ["3-1-4-2", "1-2-3-4", "3-4-1-2", "1-3-4-2"],
      a: "3-1-4-2",
      exp: "Role assignment -> Action 1 -> Action 2 -> Result."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Topic -> Activity 1 -> Activity 2 -> Result."
    },
    {
    ...
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Topic -> Art -> Transition (Also) -> Science."
    },
    {
    ...
    },
    {
      ...
      a: "2-1-3-4",
      exp: "General -> Function 1 -> Function 2 -> Negative Contrast."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Event -> Immediate Effect -> Secondary Effect -> Global Result."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Topic -> General Work -> Specific Work -> Legacy."
    },
    {
    ...
    },
    {
      ...
      a: "3-4-2-1",
      exp: "Writing structure: Outline -> Body -> Conclusion -> Edit."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Definition -> Location -> Action -> Result."
    },
    {
      ...
      options: ["3-2-4-1", "1-2-3-4", "3-4-2-1", "2-3-4-1"],
      a: "3-2-4-1",
      exp: "Effort -> Achievement -> Recognition -> Reward."
    },
    {
    ...
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Person -> Observation -> Discovery -> Impact."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Birth -> Formation -> Ignition -> Life."
    }
  ],
  ...
  expert: [
    {
      ...
      a: "2-1-3-4",
      exp: "Definition -> Mechanism (Dissonance) -> Solution A -> Solution B."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "1-3-2-4"],
      a: "2-1-3-4",
      exp: "Topic -> Theory detail -> Process -> Consequence."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-1-3-4", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Action -> Direct Effect -> Secondary Effect -> Final Classification."
    },
    {
      ...
      a: "2-3-1-4",
      exp: "Topic -> Pro -> Counter-argument (However) -> Detail of counter."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-1-3-4", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Cause -> Mechanism -> Effect -> Conclusion (Loop)."
    },
    {
      ...
      options: ["2-1-4-3", "1-2-3-4", "2-4-1-3", "1-4-2-3"],
      a: "2-1-4-3",
      exp: "Person -> Philosophy -> Specific Event -> Legacy."
    },
    {
      ...
      options: ["3-4-2-1", "1-2-3-4", "3-2-4-1", "2-3-4-1"],
      a: "3-4-2-1",
      exp: "Introduction -> Growth/Consumption -> Limit reached -> Collapse."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Definition -> Characteristic -> requirement -> Impact."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Context -> Problem -> Consequence -> Conclusion."
    },
    {
      ...
      options: ["2-4-1-3", "1-2-3-4", "2-1-4-3", "4-2-1-3"],
      a: "2-4-1-3",
      exp: "Theory -> Explanation (Who) -> Prediction (Revolt) -> Result."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Location -> Function -> Importance -> Threat."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Premise -> Action -> Result -> Definition."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Classification -> Function -> Mechanism -> Result."
    },
    {
      ...
      options: ["3-2-4-1", "1-2-3-4", "3-4-2-1", "2-3-4-1"],
      a: "3-2-4-1",
      exp: "Definition -> Capability 1 -> Capability 2 -> Limitation."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Concept -> Action -> Mechanism -> Result."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Topic -> Proposal -> Detail -> Conflict."
    },
    {
      ...
      a: "4-3-2-1",
      exp: "Definition -> Condition -> Consequence -> Conclusion."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Premise -> Mechanism (Self-interest) -> Consequence -> Terminology."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Topic -> Definition -> Mechanism -> Result."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Topic -> Elements -> Pivot -> Example."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Author -> Argument -> Mechanism -> Terminology."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Action -> Immediate Effect -> Result 1 -> Result 2."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Topic -> Proposition -> Mechanism -> Definition."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Definition (Negative) -> Definition (Positive) -> Mechanism -> Conclusion."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Topic -> Technique -> Detail -> Effect."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Topic -> Method -> Immediate Effect -> Social Effect."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Topic -> Mechanism (Simile) -> Mechanism (Scientific) -> Importance."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Topic -> Explanation -> Goal -> Example."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Definition -> Benefit -> Pivot -> Specific Concern."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Topic -> Specific Cause -> Effect 1 -> Effect 2."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Location -> Origin -> Symbolism -> Historical Context."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Topic -> Detail (Statistic) -> Name -> Cause."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Limitation -> Contrast -> Method -> Example."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Founder -> Core Tenet 1 -> Core Tenet 2 -> Goal."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Topic -> Definition -> Action required -> Paradoxical Conclusion."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Definition -> Requirement -> Economic Term -> Controversy."
    },
    {
    ...
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Goal -> Action -> Mechanism -> Result."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Definition -> Method -> Application -> Goal."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Subject -> Technique -> Effect -> Interpretation."
    },
    {
      ...
      options: ["2-4-3-1", "1-2-3-4", "2-3-4-1", "4-2-3-1"],
      a: "2-4-3-1",
      exp: "Concept -> Example -> Alternative Explanation -> Conclusion."
    },
    {
      ...
      options: ["2-1-3-4", "1-2-3-4", "2-3-1-4", "3-2-1-4"],
      a: "2-1-3-4",
      exp: "Origin -> Focus -> Theory -> Application."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Mechanism (Approach) -> Effect (Pitch) -> Mechanism (Retreat) -> Name."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Topic -> Explanation -> Definition -> Goal."
    },
    {
      ...
      options: ["2-3-1-4", "1-2-3-4", "2-1-3-4", "3-2-1-4"],
      a: "2-3-1-4",
      exp: "Aphorism -> Effect -> Critique -> Correction."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Definition -> Supplier Reaction -> Consumer Reaction -> Result."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Event -> Immediate Effect -> Chain Reaction -> Final Result."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Topic -> Mechanism -> Consequence -> Conclusion."
    },
    {
      ...
      options: ["2-3-4-1", "1-2-3-4", "2-4-3-1", "3-2-4-1"],
      a: "2-3-4-1",
      exp: "Definition -> Mechanism -> Purpose -> Result/Nature."
    }
  ]
};
