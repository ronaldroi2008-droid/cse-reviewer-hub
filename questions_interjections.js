const INTERJECTION_QUESTIONS = {
  ...
  super: [
    ...
    { question: "The interjection 'Zounds' is a corruption of:", choices: ["God's Wounds", "Zeus's Hounds", "Sounds", "Zoo Sounds"], correctIndex: 0, explanation: "It is an archaic oath representing 'God's Wounds' (referring to the crucifixion), used to express surprise or anger." },
    { question: "The interjection 'Gad' or 'Egad' refers to:", choices: ["God", "Dad", "Goat", "Good"], correctIndex: 0, explanation: "It is a 'minced oath' (a polite substitute) used to avoid saying the name 'God' directly in vain." },
    { question: "The interjection 'Blimey' (British) comes from:", choices: ["God blind me", "Blind mice", "Limey", "Blue me"], correctIndex: 0, explanation: "It is a contraction of the phrase 'God blind me', used to express strong surprise." },
    { question: "The interjection 'Strewth' comes from:", choices: ["God's Truth", "True Story", "Strength", "Straw"], correctIndex: 0, explanation: "'Strewth' is archaic British slang for 'God's Truth', used to express shock or disbelief." },
    { question: "The interjection 'Gadzooks' comes from:", choices: ["God's Hooks", "God's Books", "Gadgets", "Zookeepers"], correctIndex: 0, explanation: "It refers to 'God's Hooks' (the nails of the cross), functioning as a mild oath of surprise." },
    { question: "The interjection 'Cripes' is a substitute for:", choices: ["Christ", "Crisps", "Cry", "Crepes"], correctIndex: 0, explanation: "It is a polite substitute ('minced oath') to avoid saying 'Christ' directly when frustrated." },
    { question: "The word 'Hail' (e.g., Hail, Caesar!) means:", choices: ["Be healthy/Salute", "Ice rain", "Stop", "Goodbye"], correctIndex: 0, explanation: "It comes from Old Norse/English meaning 'Be Healthy'. It is used as a salute or greeting." },
    { question: "The interjection 'Prithee' is short for:", choices: ["I pray thee", "Pretty thee", "Pride thee", "Pay thee"], correctIndex: 0, explanation: "'Prithee' is an archaic way of saying 'Please' (literally: 'I pray thee' or 'I ask you')." },
    { question: "The interjection 'Lackaday' expresses:", choices: ["Sorrow (Alack the day)", "Laziness", "Happiness", "Confusion"], correctIndex: 0, explanation: "It is short for 'Alack the day' (Shame on the day), used to express regret or sorrow." },
    { question: "The interjection 'Heigh-ho' expresses:", choices: ["Boredom or Weariness", "Excitement", "Anger", "Fear"], correctIndex: 0, explanation: "This sound is often used to show a sigh of resignation, boredom, or disappointment." },

    // 11-20: Dialectal & Cultural
    { question: "In Scottish English, 'Och' is similar to:", choices: ["Oh / Ah", "No", "Yes", "Goodbye"], correctIndex: 0, explanation: "'Och' is a Scottish interjection used to express surprise, pain, or annoyance (e.g., 'Och aye')." },
    { question: "In Canadian English, which interjection is iconic?", choices: ["Eh?", "Innit?", "Right?", "Hey?"], correctIndex: 0, explanation: "'Eh?' is used at the end of sentences to ask for agreement, confirmation, or repetition." },
    { question: "In British English, 'Ta' means:", choices: ["Thanks", "Goodbye", "Yes", "No"], correctIndex: 0, explanation: "'Ta' is a common, casual slang word for 'Thank you' in Britain and Australia." },
    { question: "In Australian English, 'Crikey' expresses:", choices: ["Surprise/Amazement", "Sadness", "Sleep", "Hunger"], correctIndex: 0, explanation: "Made famous by Steve Irwin, 'Crikey' is an exclamation of surprise or amazement." },
    { question: "In American Southern English, 'Howdy' is short for:", choices: ["How do you do?", "How is daddy?", "How day?", "How die?"], correctIndex: 0, explanation: "It is a friendly rural greeting derived from the formal phrase 'How do you do?'." },
    { question: "The interjection 'Oy' or 'Oi' is used to:", choices: ["Get attention (often aggressively)", "Sleep", "Eat", "Cry"], correctIndex: 0, explanation: "Common in British/Australian English, 'Oi!' is a sharp shout to get someone's attention." },
    { question: "In Jewish culture/Yiddish, 'Oy vey' expresses:", choices: ["Dismay or Exasperation", "Joy", "Hello", "Goodbye"], correctIndex: 0, explanation: "It literally translates to 'Oh, woe', used to express frustration, grief, or dismay." },
    { question: "The interjection 'Aloha' serves as:", choices: ["Hello and Goodbye", "Only Hello", "Only Goodbye", "Thank you"], correctIndex: 0, explanation: "In Hawaiian culture, 'Aloha' functions as both a greeting (Hello) and a farewell (Goodbye)." },
    { question: "In Japanese/Anime culture, 'Kawaii' is an adjective often used as an interjection meaning:", choices: ["Cute!", "Scary!", "Fast!", "Stop!"], correctIndex: 0, explanation: "It is exclaimed when seeing something adorable or lovely." },
    { question: "The nautical interjection 'Ahoy' is used to:", choices: ["Hail a ship or person", "Say goodbye", "Warn of sinking", "Ask for food"], correctIndex: 0, explanation: "Sailors use 'Ahoy' to call out to another ship or to get attention." },

    // 21-30: Onomatopoeia as Interjections
    { question: "Which sound represents an explosion?", choices: ["Kaboom", "Swoosh", "Plop", "Buzz"], correctIndex: 0, explanation: "'Kaboom' mimics the loud sound of a blast or explosion." },
    { question: "Which sound represents movement through air?", choices: ["Whoosh", "Thud", "Splash", "Crunch"], correctIndex: 0, explanation: "'Whoosh' mimics the sound of wind or an object flying fast." },
    { question: "Which sound represents hitting water?", choices: ["Splash", "Bang", "Zap", "Honk"], correctIndex: 0, explanation: "'Splash' mimics the sound of an object striking liquid." },
    { question: "Which sound represents a heavy object falling?", choices: ["Thud", "Ping", "Sizzle", "Chirp"], correctIndex: 0, explanation: "'Thud' mimics the dull, heavy sound of an impact on the ground." },
    { question: "Which sound represents electricity or speed?", choices: ["Zap", "Moo", "Quack", "Drip"], correctIndex: 0, explanation: "'Zap' mimics the sharp sound of an electrical strike or sudden beam." },
    { question: "Which sound represents eating crisply?", choices: ["Crunch", "Slurp", "Gulp", "Hiss"], correctIndex: 0, explanation: "'Crunch' mimics the noise of biting into something hard." },
    { question: "Which sound represents drinking liquid?", choices: ["Slurp", "Crunch", "Bang", "Pop"], correctIndex: 0, explanation: "'Slurp' mimics the sucking sound made while drinking." },
    { question: "Which sound represents something disappearing?", choices: ["Poof", "Thud", "Clank", "Meow"], correctIndex: 0, explanation: "'Poof' mimics the sudden, soft sound of something vanishing like smoke." },
    { question: "Which sound represents a metallic hit?", choices: ["Clank/Clang", "Thump", "Swish", "Hush"], correctIndex: 0, explanation: "'Clank' or 'Clang' mimics the ringing sound of metal hitting metal." },
    { question: "Which sound represents a clock?", choices: ["Tick-tock", "Ding-dong", "Beep", "Honk"], correctIndex: 0, explanation: "'Tick-tock' mimics the rhythmic mechanical sound of a clock." },

    // 31-40: Linguistic Categories (Super Technical)
    { question: "Interjections are part of which word class category?", choices: ["Open Class", "Closed Class", "Verbs", "Pronouns"], correctIndex: 0, explanation: "They are 'Open Class' because we can easily invent new interjections (like 'D'oh!' or 'Meh') compared to pronouns which rarely change." },
    { question: "An interjection that mimics a sound is called:", choices: ["Onomatopoeic", "Alphabetic", "Numeric", "Symbiotic"], correctIndex: 0, explanation: "Onomatopoeic words (like 'Bang' or 'Meow') are words that sound like what they describe." },
    { question: "Primary Interjections are words that:", choices: ["Are only used as interjections (e.g., Ouch)", "Are nouns used as interjections", "Are verbs", "Are adjectives"], correctIndex: 0, explanation: "Primary interjections (like 'Ouch', 'Phew', 'Oops') have no other meaning. Secondary interjections (like 'Good heavens') come from other words." },
    { question: "Secondary Interjections are:", choices: ["Words from other classes used as interjections (e.g., 'Help!')", "Sounds like 'Ouch'", "Numbers", "Letters"], correctIndex: 0, explanation: "These are Nouns, Verbs, or Adjectives (e.g., 'Great!', 'Help!', 'Fire!') that function as exclamations." },
    { question: "A 'Minced Oath' is:", choices: ["A softened swear word (e.g., Gosh instead of God)", "A type of meat", "A political promise", "A lie"], correctIndex: 0, explanation: "In linguistics, a 'minced oath' is a euphemism used to replace a profane or blasphemous word (e.g., 'Fudge' instead of the F-word)." },
    { question: "Which of these is a 'Phatic' interjection?", choices: ["Uh-huh (Checking contact)", "Ouch", "Wow", "Alas"], correctIndex: 0, explanation: "Phatic expressions (like 'Mmhmm' or 'Really?') are used just to keep the conversation going and show you are listening." },
    { question: "The word 'Bazinga' is an example of:", choices: ["A pop-culture neologism interjection", "An archaic word", "A French word", "A Latin word"], correctIndex: 0, explanation: "It was coined in the TV show 'The Big Bang Theory', showing how pop culture creates new interjections." },
    { question: "In comics, interjections are often contained in:", choices: ["Speech bubbles / Burst balloons", "Footnotes", "Titles", "Margins"], correctIndex: 0, explanation: "The jagged, explosive-looking bubbles usually indicate shouting, loud noises, or strong interjections." },
    { question: "Which interjection is a palindrome?", choices: ["Wow", "Ouch", "Hey", "Alas"], correctIndex: 0, explanation: "'Wow' is spelled the same backward and forward." },
    { question: "The hesitation sound 'Um' is technically called a:", choices: ["Filler", "Stopper", "Blocker", "Breaker"], correctIndex: 0, explanation: "Linguists call these 'fillers' or 'discourse markers' because they fill the silence while the brain is thinking." },

    // 41-50: Literary Usage
    { question: "In Shakespeare, 'Ho!' is used to:", choices: ["Call attention or summon", "Laugh", "Sleep", "Cry"], correctIndex: 0, explanation: "'Ho!' (as in 'What ho!') is an archaic shout used to call someone's attention, similar to 'Hey!' today." },
    { question: "The phrase 'Humbug' acts as an interjection meaning:", choices: ["Deception/Nonsense", "Candy", "Bug", "Music"], correctIndex: 0, explanation: "Scrooge famously shouted 'Bah! Humbug!' to reject the Christmas spirit. 'Humbug' literally means deceptive nonsense or something fake." },
    { question: "Sherlock Holmes might say 'Elementary!' as an interjection of:", choices: ["Dismissive confidence", "Confusion", "Fear", "Pain"], correctIndex: 0, explanation: "Holmes uses this to tell Watson that the solution is simple, basic, or obvious." },
    { question: "Homer Simpson's catchphrase 'D'oh!' expresses:", choices: ["Annoyed realization of a mistake", "Joy", "Fear", "Love"], correctIndex: 0, explanation: "Homer says 'D'oh!' whenever he makes a stupid mistake. It became so famous that it was officially added to the Oxford English Dictionary!" },
    { question: "The interjection 'Bother!' (used by Winnie the Pooh) expresses:", choices: ["Mild annoyance", "Extreme rage", "Happiness", "Hunger"], correctIndex: 0, explanation: "'Bother' is a very mild, polite British complaint used when something goes slightly wrong." },
    { question: "In older texts, 'Fie, foh, and fum' are associated with:", choices: ["Giants", "Fairies", "Elves", "Knights"], correctIndex: 0, explanation: "These are the nonsense angry sounds made by the Giant in the fairy tale 'Jack and the Beanstalk'." },
    { question: "The word 'Hail' in 'Hail Mary' acts as:", choices: ["A greeting/Salutation", "Weather", "Goodbye", "Question"], correctIndex: 0, explanation: "'Hail' is an archaic way of saying 'Hello' or 'Greetings'. The prayer 'Ave Maria' translates to 'Hail (Greetings), Mary'." },
    { question: "Which author coined the interjection 'Yahoo' (as a noun/creature)?", choices: ["Jonathan Swift", "Shakespeare", "Dickens", "Twain"], correctIndex: 0, explanation: "Jonathan Swift invented the word 'Yahoo' in his book *Gulliver's Travels* to describe brutish creatures. Today, we use it as a shout of excitement." },
