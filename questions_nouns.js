...
window.VERBAL_QUESTION_BANK["nouns"] = {
  ...
  expert: [
    // 1-15: Tricky Subject-Verb Agreement & Collective Nouns
    {
      ...
      options: ["The committee have submitted its report.", "The committee has submitted its report.", "The committee have submitted their report it.", "The committee has submitted their report."],
      answer: "The committee has submitted its report.",
      explanation: 'Committee acting as one unit takes a singular verb and pronoun (has/its).'
    },
    {
      question: "Choose the correct sentence:",
      options: ["The committee are arguing among themselves.", "The committee is arguing among themselves.", "The committee is arguing among itself.", "The committee arguing."],
      answer: "The committee are arguing among themselves.",
      explanation: 'When members act individually (arguing), use plural verb.'
    },
    {
      question: "My family ___ from Brazil.",
      options: ["come", "comes", "are coming", "were coming"],
      answer: "comes",
      explanation: 'Family as a unit is singular.'
    },
    {
      question: "The police ___ investigating.",
      options: ["is", "are", "was", "has"],
      answer: "are",
      explanation: '"Police" is always plural in English.'
    },
    {
      question: "The news ___ bad today.",
      options: ["are", "is", "were", "have been"],
      answer: "is",
      explanation: '"News" looks plural but is singular.'
    },
    {
      question: "Mathematics ___ difficult for some.",
      options: ["are", "is", "were", "be"],
      answer: "is",
      explanation: 'Fields of study ending in "s" are singular.'
    },
    {
      question: "The scissors ___ on the table.",
      options: ["is", "are", "was", "be"],
      answer: "are",
      explanation: '"Scissors" is a plural noun (implies two parts).'
    },
    {
      question: "A pair of scissors ___ on the table.",
      options: ["is", "are", "were", "have"],
      answer: "is",
      explanation: '"Pair" is the subject, which is singular.'
    },
    {
      question: "Ten dollars ___ a high price.",
      options: ["is", "are", "were", "am"],
      answer: "is",
      explanation: 'Money amounts spoken as a total sum are singular.'
    },
    {
      question: "The staff ___ in a meeting.",
      options: ["is", "are", "was", "has"],
      answer: "is",
      explanation: 'Staff as a unit is singular.'
    },
    {
      question: "The staff ___ disagreeing on the proposal.",
      options: ["is", "are", "was", "has"],
      answer: "are",
      explanation: 'Individual members disagreeing requires plural.'
    },
    {
      question: "Economics ___ my major.",
      options: ["are", "is", "were", "have"],
      answer: "is",
      explanation: 'Field of study = singular.'
    },
    {
      question: "Measles ___ a contagious disease.",
      options: ["are", "is", "were", "have"],
      answer: "is",
      explanation: 'Disease names ending in s are usually singular.'
    },
    {
      question: "The cattle ___ grazing.",
      options: ["is", "are", "was", "has"],
      answer: "are",
      explanation: '"Cattle" is always plural.'
    },
    {
      question: "Everyone ___ here.",
      options: ["are", "is", "were", "have"],
      answer: "is",
      explanation: 'Indefinite pronouns (everyone, anyone) are singular.'
    },

    // 16-30: Foreign/Latin Plurals
    {
      question: "What is the plural of 'criterion'?",
      options: ["criterions", "criteria", "criterias", "criterion"],
      answer: "criteria",
      explanation: 'Greek origin irregular plural.'
    },
    {
    ...
    {
      question: "What is the plural of 'alumnus' (male)?",
      options: ["alumnuses", "alumni", "alumnae", "alumnum"],
      answer: "alumni",
      explanation: 'Latin masculine plural.'
    },
    {
      question: "What is the plural of 'alumna' (female)?",
      options: ["alumnas", "alumni", "alumnae", "alumnus"],
      answer: "alumnae",
      explanation: 'Latin feminine plural.'
    },
    {
      question: "What is the plural of 'datum'?",
      options: ["datums", "data", "datas", "date"],
      answer: "data",
      explanation: '"Data" is technically the plural of "datum".'
    },
    {
      question: "What is the plural of 'analysis'?",
      options: ["analyses", "analysises", "analysises", "analysi"],
      answer: "analyses",
      explanation: 'Change "is" to "es".'
    },
    {
    ...
    },
    {
      ...
      options: ["radiuses", "radii", "radees", "radi"],
      answer: "radii",
      explanation: 'Latin "us" changes to "ii".'
    },
    {
      question: "What is the plural of 'nucleus'?",
      options: ["nucleuses", "nuclei", "nucleis", "nuclear"],
      answer: "nuclei",
      explanation: 'Latin "us" changes to "i".'
    },
    {
      question: "What is the plural of 'appendix'?",
      options: ["appendixes", "appendices", "Both A and B", "appendi"],
      answer: "Both A and B",
      explanation: 'Both are accepted, but appendices is more formal.'
    },
    {
      question: "Singular of 'bacteria':",
      options: ["bacterium", "bacterias", "bacteri", "bacteria"],
      answer: "bacterium",
      explanation: 'Bacteria is plural; Bacterium is singular.'
    },
    {
      question: "Singular of 'media':",
      options: ["medium", "medias", "medi", "media"],
      answer: "medium",
      explanation: 'Media is plural; Medium is singular.'
    },
    {
      question: "Plural of 'syllabus':",
      options: ["syllabi", "syllabuses", "Both A and B", "syllab"],
      answer: "Both A and B",
      explanation: 'Both Latin (syllabi) and English (syllabuses) forms are used.'
    },
    {
      question: "Plural of 'index':",
      options: ["indexes", "indices", "Both A and B", "index"],
      answer: "Both A and B",
      explanation: 'Indexes (lists), Indices (math).'
    },
    {
      question: "Plural of 'series':",
      options: ["serieses", "serie", "series", "seri"],
      answer: "series",
      explanation: 'Series is the same in singular and plural.'
    },

    // 31-40: Possession Nuances
    {
      question: "___ car is new. (Owned by both Ben and Jerry jointly)",
      options: ["Ben's and Jerry's", "Ben and Jerry's", "Ben's and Jerry", "Ben and Jerrys'"],
      answer: "Ben and Jerry's",
      explanation: 'Joint possession: add \'s only to the last name.'
    },
    {
      question: "___ hair colors are different. (Owned separately)",
      options: ["Susan and Mary's", "Susan's and Mary's", "Susan and Marys'", "Susans and Marys"],
      answer: "Susan's and Mary's",
      explanation: 'Separate possession: add \'s to both names.'
    },
    {
      question: "My ___ house is big. (One boss)",
      options: ["boss's", "boss'", "bosses", "Both A and B"],
      answer: "Both A and B",
      explanation: 'Both styles are accepted for singular nouns ending in s.'
    },
    {
      question: "I met ___ sister.",
      options: ["a friend of my", "a friend of mine", "a friend of me", "friend of mine"],
      answer: "a friend of mine",
      explanation: 'Double genitive structure (of + possessive pronoun).'
    },
    {
      question: "It is ___ fault.",
      options: ["nobody's", "nobodies", "nobodys", "nobody"],
      answer: "nobody's",
      explanation: 'Indefinite pronouns take an apostrophe s.'
    },
    {
      question: "For ___ sake!",
      options: ["goodness'", "goodness's", "goodnes", "goodn's"],
      answer: "goodness'",
      explanation: 'Fixed expression: usually just apostrophe.'
    },
    {
      question: "The ___ wife.",
      options: ["Prince of Wales's", "Prince's of Wales", "Prince of Wales'", "Both A and C"],
      answer: "Both A and C",
      explanation: 'Possessive attaches to the end of the full title.'
    },
    {
      question: "Possessive of 'someone else':",
      options: ["someone's else", "someone else's", "someone elses'", "someone elses"],
      answer: "someone else's",
      explanation: 'Add \'s to the end of the phrase.'
    },
    {
      question: "The ___ decision.",
      options: ["editor-in-chief's", "editor's-in-chief", "editors-in-chief", "editor-in-chiefs"],
      answer: "editor-in-chief's",
      explanation: 'Possessive goes at the end of compound noun.'
    },
    {
      question: "Three ___ time.",
      options: ["month's", "months'", "months's", "months"],
      answer: "months'",
      explanation: 'Plural time expression: months + apostrophe.'
    },

    // 41-50: Advanced Syntax & Nominalization
    {
      question: "Identify the nominalization (Verb turned into Noun):",
      options: ["He reacted quickly.", "His reaction was quick.", "He acts fast.", "Reacting is fast."],
      answer: "His reaction was quick.",
      explanation: '"Reaction" is the noun form of the verb "react".'
    },
    {
      question: "Attributive Noun usage: Which is correct?",
      options: ["A table's leg", "A table leg", "A leg of table", "Leg table"],
      answer: "A table leg",
      explanation: 'For inanimate objects, we often use the noun as an adjective (Attributive Noun).'
    },
    {
      question: 'In "The poor need help," "The poor" is:',
      options: ["Adjective", "Noun phrase acting as plural subject", "Adverb", "Verb"],
      answer: "Noun phrase acting as plural subject",
      explanation: 'Adjective functioning as a collective noun.'
    },
    {
      question: "Choose the correct noun phrase order:",
      options: ["The red big beautiful ball", "The beautiful big red ball", "The big beautiful red ball", "The red beautiful big ball"],
      answer: "The beautiful big red ball",
      explanation: 'Order of adjectives: Opinion-Size-Age-Shape-Color-Origin-Material-Purpose.'
    },
    {
      question: 'What type of noun is "Self-esteem"?',
      options: ["Simple", "Compound", "Proper", "Collective"],
      answer: "Compound",
      explanation: 'Hyphenated compound noun.'
    },
    {
      question: 'In "I consider him a genius", "genius" is:',
      options: ["Direct Object", "Object Complement", "Indirect Object", "Appositive"],
      answer: "Object Complement",
      explanation: 'Completes the thought about the object "him".'
    },
    {
      question: "Which sentence uses a 'Noun Adjunct'?",
      options: ["The soup is chicken.", "It is a chicken soup.", "The soup has chicken.", "Chicken is good."],
      answer: "It is a chicken soup.",
      explanation: '"Chicken" acts as an adjective modifying "soup".'
    },
    {
      question: "Correct form:",
      options: ["Five-year-old boy", "Five-years-old boy", "Five-years-olds boy", "Five-year-olds boy"],
      answer: "Five-year-old boy",
      explanation: 'Compound modifiers before a noun are singular and hyphenated.'
    },
    {
      question: "Correct form:",
      options: ["Two dozen eggs", "Two dozens eggs", "Two dozens of eggs", "Two dozen of egg"],
      answer: "Two dozen eggs",
      explanation: 'Dozen stays singular after a number (two dozen, not dozens).'
    },
    {
      ...
      answer: "Plural form, Singular meaning",
